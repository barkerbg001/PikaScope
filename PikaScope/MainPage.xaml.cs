using PikaScope.ViewModels;
using PikaScope.Views;
using System;
using System.ComponentModel;
using System.Diagnostics;
using System.Linq;
using Xamarin.Forms;
using static PikaScope.Helpers;
...
namespace PikaScope
{
    ...
    public partial class MainPage : ContentPage
    {
        ...
        private HeroCardsViewModel HeroCardsViewModel = new HeroCardsViewModel();
        public MainPage()
        {
            InitializeComponent();
            HeroCardsViewModel = new HeroCardsViewModel();
            this.BindingContext = HeroCardsViewModel;
        }
