    ...
    public class HeroCardsViewModel
    {
        ...
        public async void SetData()
        {
            ...
            for (int i = 0 ; i < 1000 ; i++)
            {
                ...
                var data = JsonConvert.DeserializeObject<PokemonDto>(response);

                var d = new Hero()
                {
                    HeroName = data.Id.ToString(),
                    RealName = data.Name,
                    Image = $"https://assets.pokemon.com/assets/cms2/img/pokedex/full/{formattedNumber}.png",
